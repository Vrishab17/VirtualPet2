...
public class Game {
    ...
    public static void Game(Pet pet, Player player) {

        boolean restart = false; // Flag to indicate if the game should return to the main menu
        LinkedList<Pet> pets = PetSave.loadPets(); // Load the list of pets
        Scanner scanner;
        ...
        // Update the pet's data in the list before saving
        ...
        PetSave.savePets(pets); // Save the updated pet list
